...
from modules.certificate_of_occupancy.router import router as certificate_of_occupancy_router  # noqa: E402

app.include_router(sales_router)
app.include_router(inventory_router)
app.include_router(permits_router)
app.include_router(commission_router)
app.include_router(certificate_of_occupancy_router)
