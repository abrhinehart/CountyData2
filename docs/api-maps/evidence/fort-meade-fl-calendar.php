...
RZ.pagetemplatename = 'calendar'
RZ.pagetemplateid = '28'
RZ.pagemodule = ''
RZ.pagemoduleid = ''
RZ.pagerecordid = '';
...
<div id="slider">
	...
	<div class="sliderbtn">
        ...
        <script language="JavaScript" type="text/JavaScript">
            RZ.module = 'slider';
            RZ.nexturl = "editforms/slider-editlist.jsp?pageid=calendar";
...
<a href="./">Home</a> &nbsp;&nbsp;calendar
            ...
            <script language="JavaScript" type="text/JavaScript">
                ...
                RZ.set = 'freeform.pageid=calendar';
                RZ.options = '';
...
<div id="post">
    <iframe src="calendar_app/index.html#css=css/calendar_style_fortmeadefl.css" width="100%" height="1250" frameborder="0"></iframe>
</div><!-- /#post -->
		</article><!--/#entry-->
	</div><!--/.container-->
	...
	<div class="container">
		<div class="row">
			...
			<div class="col-md-6 text-right" id="revize">
                ...
                <a href="https://cms2.revize.com/revize/security/index.jsp?webspace=fortmeadefl&filename=/calendar.php" id="revize-login">Login</a>
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<div class="copylink">
					...
					<pre>&lt;a href="http://www.cityoffortmeade.org/calendar.php">Your Link Name&lt;/a&gt;</pre>
				</div><!-- /.copylink -->
				<div class="share-btns">
					<p>Share this page on your favorite Social network</p>
					<div class="row">
						<div class="col-md-3 col-xs-6">
							<a href="https://www.facebook.com/sharer/sharer.php?u=http://www.cityoffortmeade.org/calendar.php" class="btn-facebook" onclick="return !window.open(this.href, 'facebook ', 'width=500,height=500')"
							target="_blank">
								<i class="fa fa-facebook"></i> Facebook
							</a>
						</div>
						<div class="col-md-3 col-xs-6">
							<a href="https://www.twitter.com/home?status=http://www.cityoffortmeade.org/calendar.php" class="btn-twitter" onclick="return !window.open(this.href, 'twitter ', 'width=500,height=500')"
							target="_blank">
								<i class="fa fa-twitter"></i> Twitter
							</a>
						</div>
						<div class="col-md-3 col-xs-6">
							<a href="https://www.plus.google.com/share?url=http://www.cityoffortmeade.org/calendar.php" class="btn-google" onclick="return !window.open(this.href, 'google ', 'width=500,height=500')"
							target="_blank">
								<i class="fa fa-google-plus"></i> Google Plus
							</a>
						</div>
						<div class="col-md-3 col-xs-6">
							<a href="https://www.reddit.com/submit?url=http://www.cityoffortmeade.org/calendar.php" class="btn-reddit" onclick="return !window.open(this.href, 'redit ', 'width=500,height=500')"
							target="_blank">
