...
JURISDICTIONS = [
    ...
    ("Okeechobee County", "Okeechobee", None, "FL", "okeechobee",
     ...
     "tyler-epl", "https://www.okeechobeecountyfl.gov/departments/community-development/building-department/online-permitting-and-inspections",
     "research-only", None),
    ("Citrus County", "Citrus", None, "FL", "citrus-county",
     "modules.permits.scrapers.adapters.citrus_county.CitrusCountyAdapter",
     "jsf-primefaces-public-search", "https://apps.citrusbocc.com/permitsearch/search.xhtml",
     "research-only", None),
