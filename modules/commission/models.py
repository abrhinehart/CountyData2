...
class CrSourceDocument(Base):
    ...
    event_portal_url = Column(Text, nullable=True)
    event_location = Column(Text, nullable=True)
    event_time = Column(Text, nullable=True)
    event_comment = Column(Text, nullable=True)
    agenda_status_name = Column(String(50), nullable=True)
    agenda_last_published_utc = Column(DateTime(timezone=True), nullable=True)
    minutes_status_name = Column(String(50), nullable=True)
    minutes_last_published_utc = Column(DateTime(timezone=True), nullable=True)
    created_at = Column(DateTime(timezone=True), default=utc_now)
    updated_at = Column(DateTime(timezone=True), default=utc_now, onupdate=utc_now)
