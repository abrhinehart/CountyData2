"""
Sales module router — new home transaction/sales data from county records.

Wraps existing ETL, export, and query functions with REST endpoints.
Formerly the monolithic api.py.
"""
...
from etl import load_config, process_county, resolve_county_names
...
@router.get("/subdivisions/{subdivision_id}")
...
@router.patch("/transactions/{transaction_id}/resolve")
...
@router.post("/transactions/{transaction_id}/resolve-action")
...
@router.post("/export/review-queue")
